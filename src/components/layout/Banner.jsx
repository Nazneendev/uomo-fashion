              ...
              <Flex className="justify-between flex-col lg:flex-row ">
                ...
                <div className="sm:ml-[20px] md:ml-[20px]">
                  <div className="flex items-center gap-x-4 mb-6">
                    ...
                    <h3 className="font-jost text-[#C32929] font-medium leading-[24px] sm:text-[14px] text-[18px]">SUMMER 2025</h3>
                  </div>
                  <h1 className="text-textC font-jost font-bold text-[75px] sm:text-[45px] leading-[80px]">HELLO NEW SEASON</h1>
              ...
              <Flex className="justify-between flex-col lg:flex-row ">
                ...
                <div className="sm:ml-[20px] md:ml-[20px]">
                  <div className="flex items-center gap-x-4 mb-6">
                    ...
                    <h3 className="font-jost text-[#C32929] font-medium leading-[24px] sm:text-[14px] text-[18px]">NEW TREND</h3>
                  </div>
                  <h1 className="text-textC font-jost  text-[75px] leading-[80px] sm:text-[45px] font-bold">SUMMER SALE STYLISH </h1>
                  <p className="leading-[19px] text-[16px] text-textC font-medium mt-5 sm:text-[14px]">LIMITED TIME OFFER-UP TO 60% OFF & FREE SHIPPING</p>
                  <div className="mt-5 group inline-block">
