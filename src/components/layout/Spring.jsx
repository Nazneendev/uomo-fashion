...
const Spring = () => {
  return (
    <>
        ...
        <div style={{ backgroundImage: `url(${bg2nd})`}} className=" bg-center bg-cover bg-no-repeat py-[150px] ">
           <Container>
             <div className="sm:ml-[20px] md:ml-[20px]">
                  ...
                  <h1 className="text-textC font-jost font-medium lg:text-[65px] text-[65px] sm:text-[35px] leading-[80px] "><span className="text-textC font-jost lg:text-[65px] font-bold sm:text-[35px]  text-[70px]">Spring </span> Collection</h1>
