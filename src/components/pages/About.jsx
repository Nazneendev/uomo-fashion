...
<div>
 ...
 <ImHeadphones  className="text-textC font-jost font-medium  text-[80px] ml-14 "/>
  <h3 className='text-textC font-jost font-medium sm:text-[14px] text-[18px] mt-10'>24/7 CUSTOMER SUPPORT</h3>
 ...
 <MdOutlineLocalShipping className='text-textC font-jost font-medium  text-[80px] ml-14'/>
  <h3 className='text-textC font-jost font-medium  text-[18px] sm:text-[14px] mt-10'>FAST AND FREE DELIVERY</h3>
 ...
 <MdSecurity  className='text-textC font-jost font-medium  text-[80px] ml-14'/>
  <h3 className='text-textC font-jost font-medium sm:text-[14px] text-[18px] mt-10'>MONEY BACK GUARANTEE</h3>
